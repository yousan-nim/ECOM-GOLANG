// Command cart-service is the entry point (composition root) for the
// cart microservice: load config → open DB → run migrations → serve HTTP.
package main
...
import (
	...
	cart "github.com/yousan-nim/ecom/services/cart"
...
func main() {
	...
	if err := db.Migrate(sqlDB, cart.MigrationsFS); err != nil {
