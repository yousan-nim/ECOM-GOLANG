// Command review-service is the entry point (composition root) for the
// review microservice: load config → open DB → run migrations → serve HTTP.
package main
...
import (
	...
	review "github.com/yousan-nim/ecom/services/review"
...
func main() {
	...
	if err := db.Migrate(sqlDB, review.MigrationsFS); err != nil {
