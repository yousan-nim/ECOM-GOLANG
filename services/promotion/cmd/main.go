// Command promotion-service is the entry point (composition root) for the
// promotion microservice: load config → open DB → run migrations → serve HTTP.
package main
...
import (
	...
	promotion "github.com/yousan-nim/ecom/services/promotion"
...
func main() {
	...
	if err := db.Migrate(sqlDB, promotion.MigrationsFS); err != nil {
